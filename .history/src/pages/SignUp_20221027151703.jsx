            ...
            <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
                ...
                <input 
                    ...
                    <input 
                        ...
                        className="mb-6 w-full px-4 py-2 text-xl text-gray-700 bg-white border-gray-300 rounded transition ease-in-out"
                    />
                    For the password field added the condition i{/*  */}f the show password is true, we want to see the icon AiFillEyeInvisible and it it's false it shows AiFillEye
