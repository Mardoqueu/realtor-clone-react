    ...
    return (
        <section>
            ...
            <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
                ...
                <button className='w-full bg-blue-600 text-white px-7 py-3 text-sm font-medium uppercase rounded shadow-md hover:bg-blue-700 tra' type='submit'>Sing in</button>
            </div>
        </div>
