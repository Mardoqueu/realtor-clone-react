    ...
    return (
        <div className='bg-white border-b shadow-sm sticky top-0 z-50'>
            <header className='flex justify-between items-center px-3 max-w-6xl mx-auto'>
                ...
                <div>
                    Itens of menu where I used useLocation to returns the current location of each element on menu and the useNavigation  to returns the changeing of each element on menu
