...
export default function Contact({ userRef, listing }) {
  ...
  return (
    <>
{/*  if the landlord exists adn it's not equal to null, we are going to have the contact information for the listing, the text area and the button. */}
      {landlord !== null && (
        <div className="flex flex-col w-full">
          ...
          >
          {/* The button is inside an anchor tag, which is going to redirect the person to the mail software with the email and Subject. */}
